...
export function PitcherStatsCard({ stats, label = 'Season Stats', className = '' }: PitcherStatsCardProps) {
  if (!stats) {
    return (
      <div className={`rounded-lg border border-slate-700 bg-slate-800 p-4 ${className}`}>
        <h3 className="mb-2 font-semibold text-slate-100">{label}</h3>
  ...
  return (
    <div className={`rounded-lg border border-slate-700 bg-slate-800 p-4 ${className}`}>
      <h3 className="mb-4 font-semibold text-slate-100">{label}</h3>

      <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
        <div>
          <div className="text-xs text-slate-400">Games</div>
          <div className="text-2xl font-bold text-slate-100">{stats.games}</div>
        </div>
        ...
        <div>
          <div className="text-xs text-slate-400">WHIP</div>
          <div className="text-2xl font-bold text-blue-400">
        ...
        <div>
          ...
          <div className="text-2xl font-bold text-slate-100">{stats.strikeouts}</div>
        </div>

        <div>
          <div className="text-xs text-slate-400">BB</div>
          <div className="text-2xl font-bold text-slate-100">{stats.walks}</div>
        </div>

        <div>
          <div className="text-xs text-slate-400">K/9</div>
        ...
        <div>
          <div className="text-xs text-slate-400">K/BB</div>
          <div className="text-2xl font-bold text-green-400">
