  ...
  if (pitchers.length === 0) {
    return (
      <div className="rounded-lg border border-slate-700 bg-slate-800 p-8 text-center">
        <p className="text-slate-400">No pitcher stats available</p>
      </div>
    );
  }
      ...
      <table className="w-full">
        <thead className="border-b border-slate-700 bg-slate-900">
          <tr>
            ...
            <th className="px-4 py-3 text-right text-xs font-semibold text-slate-300">ERA</th>
            <th className="px-4 py-3 text-right text-xs font-semibold text-slate-300">K</th>
            <th className="px-4 py-3 text-right text-xs font-semibold text-slate-300">BB</th>
            <th className="px-4 py-3 text-right text-xs font-semibold text-slate-300">WHIP</th>
            <th className="px-4 py-3 text-right text-xs font-semibold text-slate-300">K/9</th>
          </tr>
        </thead>
