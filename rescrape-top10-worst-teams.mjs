#!/usr/bin/env node
/**
 * Rescrape headshots for the top 10 worst teams
 * Uses official school roster pages with custom logic for each site
 */
...
// Top 10 worst teams with their official roster URLs
const TEAMS_CONFIG = [
  {
    team_id: '68',
    team_name: 'USC',
  ...
  },
  {
    ...
    roster_url: 'https://gohuskies.com/sports/baseball/roster',
    missing_count: 3
  },
  {
    team_id: '52',
...
async function main() {
  console.log('🚀 Starting targeted rescraping for top 10 worst teams\n');
  ...
  // Save results
  fs.writeFileSync(
    'top10-worst-teams-results.json',
    JSON.stringify(results, null, 2)
  );
  console.log('💾 Saved results to: top10-worst-teams-results.json\n');
}
